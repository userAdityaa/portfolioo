        ...
        <div className="bg-[#111111] min-h-screen w-full overflow-y-auto transition-all duration-300">
              <div className="flex">
                ...
                <Image
                  ...
                  width={0}
                  height={0}
                  className="w-[30rem] h-[12rem] object-cover max-phone:hidden max-ipad:hidden"
                />
              </div>

              <div className="absolute left-80 top-[15rem] max-w-3xl pb-20 flex flex-col max-phone:left-4 max-mini:left-12 max-mini:w-[90%] max-ipad:left-32">
